...
//ItemBlocks
    ...
    public static final RegistryObject<BlockItem> END_LITHIUM_ORE_ITEM = ITEMS.register("end_lithium_ore",() -> new BlockItem(ModBlocks.END_LITHIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
    ...
    public static final RegistryObject<BlockItem> END_RUBIDIUM_ORE_ITEM = ITEMS.register("end_rubidium_ore",() -> new BlockItem(ModBlocks.END_RUBIDIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
    ...
    public static final RegistryObject<BlockItem> END_SCANDIUM_ORE_ITEM = ITEMS.register("end_scandium_ore",() -> new BlockItem(ModBlocks.END_SCANDIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
    ...
    public static final RegistryObject<BlockItem> END_STRONTIUM_ORE_ITEM = ITEMS.register("end_strontium_ore",() -> new BlockItem(ModBlocks.END_STRONTIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
    public static final RegistryObject<BlockItem> END_TANTALUM_ORE_ITEM = ITEMS.register("end_tantalum_ore",() -> new BlockItem(ModBlocks.END_TANTALUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
    ...
    public static final RegistryObject<BlockItem> END_VANADIUM_ORE_ITEM = ITEMS.register("end_vanadium_ore",() -> new BlockItem(ModBlocks.END_VANADIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
    public static final RegistryObject<BlockItem> END_YTTRIUM_ORE_ITEM = ITEMS.register("end_yttrium_ore",() -> new BlockItem(ModBlocks.END_YTTRIUM_ORE.get(), new Item.Properties().rarity(Rarity.COMMON)));
